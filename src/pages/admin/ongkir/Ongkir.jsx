...
const Ongkir = () => {
  const { setOngkir, dtOngkir, responses, removeData } = useOngkir();
  ...
  const headers = ["No", "Nama Kelurahan", "Harga Ongkir", "Aksi"];
  const tableBodies = [`kelurahan.nama`, `harga`];
        ...
        <div className="flex justify-between">
          <div>
            ...
            <p className="text-my-gray">
              Silahkan menambah, mengubah dan menghapus data Ongkir
            </p>
          </div>
          <div>
            <button
